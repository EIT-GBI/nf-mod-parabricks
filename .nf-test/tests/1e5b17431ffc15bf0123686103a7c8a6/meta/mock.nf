...
include { PARABRICKS_DEEPVARIANT } from '/Users/pauline.fourgoux/Documents/Code/nf-dnaseq/modules/parabricks/deepvariant/tests/../main.nf'
...
workflow {
    ...
    //run process
    PARABRICKS_DEEPVARIANT(*input)

    if (PARABRICKS_DEEPVARIANT.output){

        // consumes all named output channels and stores items in a json file
        for (def name in PARABRICKS_DEEPVARIANT.out.getNames()) {
            serializeChannel(name, PARABRICKS_DEEPVARIANT.out.getProperty(name), jsonOutput)
        }	  
      
        // consumes all unnamed output channels and stores items in a json file
        def array = PARABRICKS_DEEPVARIANT.out as Object[]
